...
<html lang="en">
  ...
  <body>
    <!-- Navigation -->
    <nav>
      <div class="logo"><span class="logo-mark">☕</span><span class="logo-text">No <strong>Cap</strong></span></div>
      ...
      <div class="nav-links" id="primary-navigation">
        ...
        <a href="menu.html" class="btn-nav">Order Now</a>
      </div>
    </nav>
      <!-- Contact Section -->
      <section class="contact-page">
        <div class="contact-container">
          <h1>Get in Touch</h1>
          <p class="contact-intro">We'd love to hear your thoughts on our coffee and service. Ask a question, share feedback, or just say hello.</p>
          <form id="contact-form" class="contact-form" onsubmit="submitContact(event)">
            <div id="contact-alert" class="form-alert" role="alert" aria-live="polite" hidden></div>
            ...
            <div class="form-field">
              <input
                ...
                required
              />
              <small class="error-text" id="name-error" role="status"></small>
            </div>
            ...
            <div class="form-field">
              <input
                ...
                required
              />
              <small class="error-text" id="email-error" role="status"></small>
            </div>
            ...
            <div class="form-field">
              <textarea
                ...
                required
              ></textarea>
              <small class="error-text" id="message-error" role="status"></small>
            </div>
    ...
    <footer>
      <div class="container footer-grid">
        ...
        <div class="footer-contact">
          <h4>Contact</h4>
          <ul>
            <li>Email: <a href="mailto:hello@nocab.cafe">hello@nocab.cafe</a></li>
